            ...
            {capabilities.map((cap) => (
              <motion.div key={cap.title} variants={fadeUp}>
                ...
                >
                  ...
                  <div className="mt-[16px] font-sans font-medium text-[12px] text-[#c39967] opacity-0 transition-all duration-300 transform translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 relative z-10">
                    Explore &rarr;
                  </div>
                </Link>
              </motion.div>
